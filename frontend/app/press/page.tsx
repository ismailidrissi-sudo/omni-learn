        ...
        <div className="mt-8 space-y-6 text-gray-700 dark:text-gray-300">
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-heading">
              {t("pages.press.section1Title")}
            </h2>
            <p className="mt-2">{t("pages.press.section1Content")}</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-heading">
              {t("pages.press.section2Title")}
            </h2>
            <p className="mt-2">{t("pages.press.section2Content")}</p>
          </section>
        </div>
